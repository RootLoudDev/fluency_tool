...
<script type="text/javascript" src="script/fluency.js"></script>
</head>
...
function callUserDelete(value){
	...
	ajaxRequest.open("POST", "scenDelete.php", true);
...
<a href="admin.php">Edit Users</a> &nbsp; | &nbsp; Edit Scenarios
<br/><br/>
<a href="add_scenario.html?height=500&width=800" class="thickbox" title="New Scenario">New Scenario</a>
<a href="javascript:void" onCLick="deleteUsers()" title="Delete Scenario">Delete Scenario</a>
	...
	<form action="" method="" name="adminForm" id="adminForm" onsubmit="">
		...
		<table width="750" border="0">
			<tr>
				<td width="20"></td>
				<td width="100"><u>Scenario</u></td>
				<td width="100"><u>Description</u></td>
			</tr>
<?php
...
$sql = "SELECT scenarios.id, scenarioTitle, scenarioDescription FROM scenarios LIMIT $offset, $rowsperpage";
...
while ($list = mysql_fetch_assoc($result)) {
	...
	echo "<td onclick='toggleRow(" . $rownum . ");'>" . $list['scenarioTitle'] . "</td>";
	echo "<td onclick='toggleRow(" . $rownum . ");'>" . $list['scenarioDescription'] . "</td></tr>";

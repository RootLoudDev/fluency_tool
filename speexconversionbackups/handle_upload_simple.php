...
// Applet always sends duration in seconds along with file.
    ...
    if( (strcmp($upfile_name,"Scenario1.wav") != 0) &&
        (strcmp($upfile_name,"Scenario2.wav") != 0) &&
        (strcmp($upfile_name,"Scenario3.wav") != 0) &&
        (strcmp($upfile_name,"Scenario4.wav") != 0) &&
        (strcmp($upfile_name,"Scenario5.wav") != 0) &&
        (strcmp($upfile_name,"Scenario6.wav") != 0) &&
        (strcmp($upfile_name,"Scenario7.wav") != 0)
      )
    {

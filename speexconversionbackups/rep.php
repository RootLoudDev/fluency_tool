...
animatedcollapse.addDiv('instructions', 'fade=0,speed=400,group=pets,hide=0')
animatedcollapse.addDiv('scenario1', 'fade=0,speed=400,group=pets, hide=1')
...
<script language="javascript">
	...
	function selectScenario(scenario)
	{
		...
		case 'NONE':
			...
			break;			
		case 'one':
			if (playable && fileName != "Scenario1.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
			...
			break;
		case 'two':
			if (playable && fileName != "Scenario2.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
			...
			break;
		case 'three':
			if (playable && fileName != "Scenario3.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
			...
			break;
		case 'four':
			if (playable && fileName != "Scenario4.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
			...
			break;
		case 'five':
			if (playable && fileName != "Scenario5.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
			...
			break;
		case 'six':
			if (playable && fileName != "Scenario6.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
			...
			break;
		case 'seven':
			if (playable && fileName != "Scenario7.wav") 
			{
				document.JavaSonicRecorderUploader.erase();
			}
...
function loadIdealResponse()
{
	...
	var playStringBest = bestDir + bestScenarioFileName;
	document.ListenUpPlayer.loadRecording(playStringBest);
	document.getElementById('loadIdealResponse').disabled = true;
...
//	alert(previousState + ":" + newState + ":" + fileName);
...
function interceptToggle(divid) {
//Need a function to intercept toggle and do the following:
// nothing recorded - toggle as normal
// recording exists - prompt user
alert(divid);
...
<div id="content" align="center">
 <table width="839" border="0">
            ...
            <form action="" method="" name="territoryForm" id="territoryForm" onsubmit="">
              <table border="0" cellspacing="1" cellpadding="0">
                <tr>
                  ...
                  <a href="#" rel="toggle[instructions]" data-openimage="images/instructions-close.jpg" data-closedimage="images/instructions.jpg"><img src="collapse.jpg" border="0" /></a>

                  <div id="instructions" class="drop"><strong>Overview and Instructions</strong>
                    <p>Welcome to the Pulmozyme Fluency Tool – an online environment designed to help you become skilled at overcoming objections that you frequently hear from physicians in the field. <br />
    Using the tool, you will follow a simple process to record, review and then upload audio responses to sales scenarios. Then, you will receive feedback on your responses from either a classroom trainer, manager or field sales trainer to help you improve your effectiveness.<br />
  ...
  <p>A manager or trainer will offer feedback on your audio responses. You can return to the tool to view feedback and resume the process – positioning you to achieve sales success by overcoming objections with accuracy and effective delivery!<strong> </strong></p>
</div>

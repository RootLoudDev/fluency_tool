...
animatedcollapse.addDiv('Scen2', 'fade=0,speed=400,group=Scen,hide=0')
animatedcollapse.addDiv('Scen3', 'fade=0,speed=400,group=Scen,hide=0')
animatedcollapse.addDiv('Scen4', 'fade=0,speed=400,group=Scen,hide=0')
animatedcollapse.addDiv('Scen5', 'fade=0,speed=400,group=Scen,hide=0')
animatedcollapse.addDiv('Scen6', 'fade=0,speed=400,group=Scen,hide=0')
animatedcollapse.addDiv('Scen7', 'fade=0,speed=400,group=Scen,hide=0')
...
<script language="javascript">
	...
	function selectScenario(scenario)
	{
		...
		case 'one':
			...
			document.getElementById("nowrecording").innerHTML = fileName.replace(fileExtension, "");		
			if (scenarioDone[1] == 1) { 
...
function loadIdealResponse()
{
	...
	var fileNameDisplay = "Ideal " + fileName.replace(fileExtension, "");
	loadPlayer(playString, fileNameDisplay)	
	document.getElementById('loadIdealResponse').disabled = true;
...
<div id="Scen1" class="drop">
  ...
  <hr />
  <p><strong>Description of Resources a</strong><strong>nd Response</strong></p>
...
<div id="Scen7" class="drop">
  ...
  <ul>
    ...
    <div id="column-wide">
      ...
      <div class="contentInterior" >
	    <div id="nowrecording" style="text-align:center;" class="blue">Scenario not selected.</div>      
      <!-- Recorder Applet -->
<applet 

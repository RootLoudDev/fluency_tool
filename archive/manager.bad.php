          ...
          <div class="scenario-manager">
            <form action="" method="" name="territoryForm" id="territoryForm" onsubmit="">
              <table border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="20" bgcolor="#DCDCF6"><input type="checkbox" name="one" value="East" onclick="terrSelect()"/></td>
                  <td width="562" class="blue" bgcolor="#DCDCF6"><strong>East</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="two" value="West" onclick="terrSelect()"/></td>
                  <td class="grey" bgcolor="#DCDCF6">West</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6">&nbsp;</td>
                  <td class="blue" bgcolor="#DCDCF6"><strong>&nbsp;</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6">&nbsp;</td>
                  <td class="grey" bgcolor="#DCDCF6">&nbsp;</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6">&nbsp;</td>
                  <td class="blue" bgcolor="#DCDCF6">&nbsp;</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6">&nbsp;</td>
                  <td class="blue" bgcolor="#DCDCF6"></td>
        ...
        <div class="contentInterior">
          <div class="scenario-manager">
            <form action="" method="" name="repForm" id="repForm" onsubmit="">
              <table border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="20" bgcolor="#DCDCF6"><input type="checkbox" name="one" onclick=""/></td>
                  <td width="562" class="blue" bgcolor="#DCDCF6"><strong>John Doe</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="two" onclick=""/></td>
                  <td class="grey" bgcolor="#DCDCF6">Jane Doe</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="three" onclick=""/></td>
                  <td class="blue" bgcolor="#DCDCF6"><strong>John Doe</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="four" onclick=""/></td>
                  <td class="grey" bgcolor="#DCDCF6">&nbsp;</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="five" onclick=""/></td>
                  <td class="blue" bgcolor="#DCDCF6">&nbsp;</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="six" onclick=""/></td>
                  <td class="blue" bgcolor="#DCDCF6"></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="six2" onclick=""/></td>
                  <td class="grey" bgcolor="#DCDCF6"></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6">&nbsp;</td>
    ...
    <td width="187" valign="top">
        ...
        <div class="contentInterior">
          <div class="scenario-manager">
            <form action="" method="" name="scenarioForm" id="scenarioForm" onsubmit="">
              <table border="0" cellspacing="1" cellpadding="0">
                <tr>
                  <td width="20" class="blue" bgcolor="#DCDCF6"><input type="checkbox" name="one" onclick=""/></td>
                  <td width="562" class="blue" bgcolor="#DCDCF6"><strong>Scenario 1</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="two" onclick=""/></td>
                  <td class="grey" bgcolor="#DCDCF6">Scenario 2</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="three" onclick=""/></td>
                  <td class="blue" bgcolor="#DCDCF6"><strong>Scenario 3</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="four" onclick=""/></td>
                  <td class="grey" bgcolor="#DCDCF6">Scenario 4</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="five" onclick=""/></td>
                  <td class="blue" bgcolor="#DCDCF6"><strong>Scenario 5</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="six" onclick=""/></td>
                  <td class="grey" bgcolor="#DCDCF6">Scenario 6</td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6"><input type="checkbox" name="seven" onclick=""/></td>
                  <td class="blue" bgcolor="#DCDCF6"><strong>Scenario 7</strong></td>
                  </tr>
                <tr>
                  <td bgcolor="#DCDCF6">&nbsp;</td>
                  <td class="blue" bgcolor="#DCDCF6"></td>
      ...
      <div id="column-manager">
        ...
        <div class="contentInterior">
          ...
          <div id="menu-bar2-manager" style="text-align:center;">Optimal Response</div>
        <div class="contentInterior">
          <div class="scenario-manager-right">
            <form action="" method="" name="territoryForm" id="territoryForm" onsubmit="">
              <table border="0" cellspacing="1" cellpadding="0">
        ...
        <div class="contentInterior">
          ...
          <div align="center">
            <form action="" method="" name="notesForm" id="notesForm" onsubmit="">
              <table border="0" cellspacing="1" cellpadding="0">
             <label>
                 <textarea name="feedback2" cols="28" rows="6" id="feedback"></textarea>
                 </label>

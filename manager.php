		...
		if(ajaxRequest.readyState == 4){
			...
			for(i = 0; i < terrSelectResultsCount; i++){
				...
				if (i < terrSelectResultsCount) {
					...
					cellRadio.id = associateId;  //added an id to the individual cells
					//var el = document.createElement('input');
					//var radioButton = "<input type='radio' name='rep' value=associateId onClick=assocSelect()>"
					/**el.type = 'radio';
					el.name = 'rep';
					...
					*/
					...
					cellRadio.innerHTML = "<input type='radio' name='rep' value='" + associateId + "' onClick=assocSelect()>"
					// rep name
